...
Процедура ВывестиТаблицу()
	...
	СеткаДанных1 = Форма.ЭлементыУправления.Добавить(УправлениеФормами.СеткаДанных());
	СеткаДанных1.Стыковка = УправлениеФормами.СтильСтыковки.Заполнение;
	...
	Для Каждого ТекКолонка из ОписаниеКолонок Цикл
		...
		СтильКолонкиПолеВвода1.Выравнивание = УправлениеФормами.ГоризонтальноеВыравнивание.Центр;
	...
	СеткаДанных1.ИсточникДанных = ТаблицаДанных;

КонецПроцедуры

Процедура ЗаполнитьТаблицуИзФайла(ПутьКФайлу)

	ТаблицаДанных.Строки.Очистить();
